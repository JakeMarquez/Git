namespace DNDCalcSecure.Services {
    ...
    export class AccountService {
        ...
        public checkExistence(username) {

            var answer = this.$http.get('/api/get/checkExistence', username);
            return answer;
        }
    ...
    angular.module('DNDCalcSecure').service('accountService', AccountService);
}
